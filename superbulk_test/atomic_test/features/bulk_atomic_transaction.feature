Feature: Bulk atomic transaction
    ...
    Scenario: Testing failfast option in transaction
        Given the post data is "{"failfast": "True", "content": [{"method":"POST","uri":"/api/v1/invoice/","body":"{\"customer_id\":\"test2-test2-test2\",\"invoice_no\":\"0005\"}"},{"method":"POST","uri":"/api/v1/invoice/","body":"{\"customer_id\":\"test2-test2-test2\",\"invoice_no_field\":\"0006\"}"}]}"
        And I post the data to "/api/superbulk_transactional/"
