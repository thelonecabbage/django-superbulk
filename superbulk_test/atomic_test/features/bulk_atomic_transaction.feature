Feature: Bulk atomic transaction
    ...
    Scenario: Testing failfast option in transaction
        Given the post data is "{"failfast": "True", "content": [{"method":"POST","uri":"/api/v1/customer/","body":"{\"id\":\"test1-test1-test1\",\"name\":\"Justin\"}"},{"method":"POST","uri":"/api/v1/invoice/","body":"{\"customer_id\":\"test1-test1-test1\",\"invoice_no_field\":\"0002\"}"}]}"
        And I post the data to "/api/superbulk_transactional/"
